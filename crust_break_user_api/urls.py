...
urlpatterns = [
    ...
    path('<int:user_id>add/to-do/<int:recette_id>', views.AddRecetteToDo,name="add_user_todo_recette"),
    path('<int:user_id>/get/todo-receipes', views.getRecetteToDo,name="get_user_todo_recette"),
    
    path('<int:user_id>add/to-favorites/<int:recette_id>', views.AddRecetteToFavorites,name="add_user_favorites_recette"),
